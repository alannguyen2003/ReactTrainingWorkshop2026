    ...
    return (
        <header className="bg-white">
            <nav className="mx-auto flex min-h-[100px] w-[min(1240px,calc(100%-32px))] items-center justify-between gap-6">
                <a className="flex shrink-0 items-center gap-2 text-[34px] font-bold leading-none" href="/">
                ...
                <div className="hidden items-center gap-[72px] text-base font-medium lg:flex">
                    <a className="text-brand hover:text-brand" href="/">Home</a><a className="hover:text-brand"
                        href="/shop">Shop</a><a className="hover:text-brand" href="/about">About</a><a className="hover:text-brand"
                ...
                <div className="flex items-center gap-3 text-black sm:gap-6">
                    <button className="grid h-10 w-10 place-items-center hover:text-brand" type="button" aria-label="Account">
                        <svg className="h-7 w-7" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M20 7V10.5M20 13V13.01M8 15H16C18.2091 15 20 16.7909 20 19V21H4V19C4 16.7909 5.79086 15 8 15ZM16 7C16 9.20914 14.2091 11 12 11C9.79086 11 8 9.20914 8 7C8 4.79086 9.79086 3 12 3C14.2091 3 16 4.79086 16 7Z" stroke="#000000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                    </button>
                    ...
                    <a className="grid h-10 w-10 place-items-center hover:text-brand" href="/cart" aria-label="Cart"><svg
