export function Footer() {
    return (
        <footer className="border-t border-line bg-white pt-12">
            <div
                className="mx-auto grid w-[min(1240px,calc(100%-32px))] gap-10 pb-12 lg:grid-cols-[2fr_1fr_1fr_2fr]"
            >
                <div>
            ...
            <div
                className="mx-auto w-[min(1240px,calc(100%-32px))] border-t border-line py-9 text-sm"
            >
